...
var encode = {
   ...
   */
  core: function(filepath, data, callback) {
  ...
  text: function(message) {
    this.core(process.cwd()+'/files/cat.gif', message, function(data) {
...
var decode = {
  ...
  file: function(image, callback) {
    ...
    fs.readFile(image, function(err, gif) {
      self.decode.core(gif, function(data) {
